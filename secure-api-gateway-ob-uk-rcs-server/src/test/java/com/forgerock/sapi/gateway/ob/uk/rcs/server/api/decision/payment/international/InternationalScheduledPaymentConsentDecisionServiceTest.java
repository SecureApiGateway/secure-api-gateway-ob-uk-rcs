...
public class InternationalScheduledPaymentConsentDecisionServiceTest extends BasePaymentConsentDecisionServiceTest<InternationalScheduledPaymentConsentEntity> {

    @Mock
    private InternationalScheduledPaymentConsentService consentService;

    @InjectMocks
    private InternationalScheduledPaymentConsentDecisionService internationalPaymentConsentDecisionService;


    @Override
    protected PaymentConsentService<InternationalScheduledPaymentConsentEntity, PaymentAuthoriseConsentArgs> getPaymentConsentService() {
        return consentService;
    }

    @Override
    protected BasePaymentConsentDecisionService<InternationalScheduledPaymentConsentEntity> getConsentDecisionService() {
