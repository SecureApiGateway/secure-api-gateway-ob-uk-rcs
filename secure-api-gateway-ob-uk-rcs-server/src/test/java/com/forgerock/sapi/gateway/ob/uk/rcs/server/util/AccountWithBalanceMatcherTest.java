...
import static com.forgerock.sapi.gateway.ob.uk.common.datamodel.testsupport.FRAccountIdentifierTestDataFactory.aValidFRAccountIdentifier2;
import static com.forgerock.sapi.gateway.ob.uk.common.datamodel.testsupport.FRAccountIdentifierTestDataFactory.aValidFRAccountIdentifierBuilder;
...
import static com.forgerock.sapi.gateway.ob.uk.common.datamodel.testsupport.account.FRFinancialAccountTestDataFactory.aValidFRFinancialAccountBuilder;
...
public class AccountWithBalanceMatcherTest {
    ...
    public void shouldGetMatchingAccount() {
        ...
        // When
        Optional<FRAccountWithBalance> matchingAccount = AccountWithBalanceMatcher.getMatchingAccount(identification1, accounts);
    ...
    public void shouldNotGetMatchingAccountGivenEmptyAccounts() {
        ...
        // When
        Optional<FRAccountWithBalance> matchingAccount = AccountWithBalanceMatcher.getMatchingAccount(identification, accounts);
