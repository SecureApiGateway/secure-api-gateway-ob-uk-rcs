...
import static com.forgerock.sapi.gateway.rcs.consent.store.repo.service.payment.domestic.v3_1_10.DefaultDomesticScheduledPaymentConsentServiceTest.createValidConsentEntity;
...
import com.forgerock.sapi.gateway.ob.uk.rcs.server.api.details.payment.domestic.DomesticScheduledPaymentConsentDetailsService;
...
class DomesticScheduledPaymentConsentDetailsServiceTest extends BasePaymentConsentDetailsServiceTest {
    ...
    void testGetDomesticScheduledPaymentDetails() throws ExceptionClient {
        ...
        given(domesticScheduledPaymentConsentService.getConsent(intentId, testApiClient.getId())).willReturn(
                consentEntity);
        ...
        DomesticScheduledPaymentConsentDetails domesticScheduledPaymentDetails =
                (DomesticScheduledPaymentConsentDetails) consentDetails;
        ...
        assertThat(domesticScheduledPaymentDetails.getPaymentDate()).isEqualTo(consentEntity.getRequestObj()
                                                                                            .getData()
                                                                                            .getInitiation()
        ...
        assertThat(domesticScheduledPaymentDetails.getInitiation()).isEqualTo(consentEntity.getRequestObj()
                                                                                           .getData()
                                                                                           .getInitiation());
    ...
    public void testGetDomesticScheduledPaymentDetailsWithDebtorAccount() throws ExceptionClient {
        ...
        assertThat(consentDetails).isInstanceOf(DomesticScheduledPaymentConsentDetails.class);
        DomesticScheduledPaymentConsentDetails domesticScheduledConsentDetails =
                (DomesticScheduledPaymentConsentDetails) consentDetails;
        ...
        assertThat(domesticScheduledConsentDetails.getPaymentDate()).isEqualTo(consentEntity.getRequestObj()
                                                                                            .getData()
                                                                                            .getInitiation()
                                                                                            .getRequestedExecutionDateTime());
        assertThat(domesticScheduledConsentDetails.getInstructedAmount()).isEqualTo(new FRAmount("10.01", "GBP"));

        final FRWriteDomesticScheduledDataInitiation initiation = consentEntity.getRequestObj()
                                                                               .getData()
                                                                               .getInitiation();
