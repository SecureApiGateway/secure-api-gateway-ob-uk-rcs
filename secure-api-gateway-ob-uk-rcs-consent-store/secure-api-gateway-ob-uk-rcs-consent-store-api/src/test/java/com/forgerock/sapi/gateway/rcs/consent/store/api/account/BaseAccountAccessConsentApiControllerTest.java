...
public abstract class BaseAccountAccessConsentApiControllerTest extends BaseControllerTest<AccountAccessConsent, CreateAccountAccessConsentRequest, AuthoriseAccountAccessConsentRequest> {
    ...
    protected BaseAccountAccessConsentApiControllerTest() {
    ...
    protected void validateCreateConsentAgainstCreateRequest(AccountAccessConsent consent, CreateAccountAccessConsentRequest createConsentRequest) {
        AccountAccessConsentValidationHelpers.validateCreateConsentAgainstCreateRequest(consent, createConsentRequest, getControllerVersion());
    }
