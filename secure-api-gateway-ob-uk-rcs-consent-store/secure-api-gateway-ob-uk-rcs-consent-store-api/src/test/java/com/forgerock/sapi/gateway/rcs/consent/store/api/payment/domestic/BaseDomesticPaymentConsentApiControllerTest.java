...
public abstract class BaseDomesticPaymentConsentApiControllerTest extends BasePaymentConsentApiControllerTest<DomesticPaymentConsent, CreateDomesticPaymentConsentRequest> {

    @Autowired
    @Qualifier("internalDomesticPaymentConsentService")
    private DomesticPaymentConsentService consentService;

    public BaseDomesticPaymentConsentApiControllerTest() {
