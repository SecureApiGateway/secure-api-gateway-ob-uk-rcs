 ...
 */
@Component
public class RestInternationalScheduledPaymentConsentStoreClient extends BaseRestConsentStoreClient implements InternationalScheduledPaymentConsentStoreClient {

    private final String consentServiceBaseUrl;

    @Autowired
    public RestInternationalScheduledPaymentConsentStoreClient(ConsentStoreClientConfiguration consentStoreClientConfiguration, RestTemplateBuilder restTemplateBuilder,
