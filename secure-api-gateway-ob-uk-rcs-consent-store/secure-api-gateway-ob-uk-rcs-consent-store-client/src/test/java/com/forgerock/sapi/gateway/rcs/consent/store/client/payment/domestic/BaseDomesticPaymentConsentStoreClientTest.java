...
public abstract class BaseDomesticPaymentConsentStoreClientTest {
    ...
    protected BaseRestDomesticPaymentConsentStoreClient apiClient;

    protected BaseDomesticPaymentConsentStoreClientTest(OBVersion version) {
    ...
    protected abstract BaseRestDomesticPaymentConsentStoreClient createApiClient();
