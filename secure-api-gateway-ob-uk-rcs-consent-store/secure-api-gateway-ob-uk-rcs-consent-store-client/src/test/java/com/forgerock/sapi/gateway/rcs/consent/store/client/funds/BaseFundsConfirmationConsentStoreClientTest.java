...
import static com.forgerock.sapi.gateway.rcs.consent.store.api.funds.FundsConfirmationConsentValidationHelpers.*;
...
public abstract class BaseFundsConfirmationConsentStoreClientTest {
    ...
    protected BaseRestFundsConfirmationConsentStoreClient storeApiClient;

    protected BaseFundsConfirmationConsentStoreClientTest(OBVersion version) {
        this.version = version;
    }

    @BeforeEach
    public void beforeEach() {
        storeApiClient = createApiClient();
    }

    protected abstract BaseRestFundsConfirmationConsentStoreClient createApiClient();
