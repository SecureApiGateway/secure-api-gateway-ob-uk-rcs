...
import com.forgerock.sapi.gateway.rcs.consent.store.client.payment.internationalscheduled.v3_1_10.RestInternationalScheduledPaymentConsentStoreClient;
...
public abstract class BaseInternationalScheduledPaymentConsentStoreClientTest {
    ...
    protected BaseRestInternationalScheduledPaymentConsentStoreClient apiClient;

    protected BaseInternationalScheduledPaymentConsentStoreClientTest(OBVersion version) {
    ...
    protected abstract BaseRestInternationalScheduledPaymentConsentStoreClient createApiClient();
