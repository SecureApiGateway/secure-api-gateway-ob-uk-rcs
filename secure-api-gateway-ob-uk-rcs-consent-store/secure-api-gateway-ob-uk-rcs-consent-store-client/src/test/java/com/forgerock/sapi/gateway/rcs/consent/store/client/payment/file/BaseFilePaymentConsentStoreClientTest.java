 ...
 */
package com.forgerock.sapi.gateway.rcs.consent.store.client.payment.file;
...
import com.forgerock.sapi.gateway.rcs.consent.store.api.payment.file.FilePaymentConsentValidationHelpers;
...
import static com.forgerock.sapi.gateway.rcs.consent.store.api.payment.file.FilePaymentConsentValidationHelpers.*;
...
public abstract class BaseFilePaymentConsentStoreClientTest {
    ...
    protected BaseRestFilePaymentConsentStoreClient apiClient;

    protected BaseFilePaymentConsentStoreClientTest(OBVersion version){
    ...
    protected abstract BaseRestFilePaymentConsentStoreClient createApiClient();
