...
import com.forgerock.sapi.gateway.rcs.consent.store.client.payment.internationalstandingorder.v3_1_10.RestInternationalStandingOrderConsentStoreClient;
...
public abstract class BaseInternationalStandingOrderConsentStoreClientTest {
    ...
    protected BaseRestInternationalStandingOrderConsentStoreClient apiClient;

    protected BaseInternationalStandingOrderConsentStoreClientTest(OBVersion version) {
    ...
    protected abstract BaseRestInternationalStandingOrderConsentStoreClient createApiClient();
