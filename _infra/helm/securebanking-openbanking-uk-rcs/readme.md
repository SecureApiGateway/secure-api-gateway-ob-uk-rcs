...
|RS_API_URI | http://test-facility-bank:8080 | URI of Test Facility Bank | rs-sapig-deployment-config |
...
| RCS_CONSENT_RESPONSE_JWT_SIGNINGKEYID | rcs-jwt-signer | What is the signing key ID | rs-sapig-deployment-config |
| RCS_CONSENT_RESPONSE_JWT_ISSUER | secure-open-banking-rcs | What is the JWT responce issuer | rs-sapig-deployment-config |
