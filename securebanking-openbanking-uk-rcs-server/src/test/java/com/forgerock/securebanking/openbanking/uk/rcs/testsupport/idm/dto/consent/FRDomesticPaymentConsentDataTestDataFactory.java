...
public class FRDomesticPaymentConsentDataTestDataFactory {

    public static FRDomesticPaymentConsentData aValidDomesticPaymentConsentData() {
        return aValidDomesticPaymentConsentDataBuilder(randomUUID().toString()).build();
    }

    public static FRDomesticPaymentConsentData aValidDomesticPaymentConsentData(String consentId) {
        return aValidDomesticPaymentConsentDataBuilder(consentId).build();
    }

    public static FRDomesticPaymentConsentData.FRDomesticPaymentConsentDataBuilder aValidDomesticPaymentConsentDataBuilder(String consentId) {
        return FRDomesticPaymentConsentData.builder()
                .consentId(consentId)
