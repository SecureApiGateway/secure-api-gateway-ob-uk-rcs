...
/**
 * Unit tests for {@link FilterConfigurationProperties}
 */
@ContextConfiguration(classes = {FilterConfigurationProperties.class})
@ActiveProfiles("test")
@SpringBootTest(classes = {RcsApplicationTestSupport.class}, webEnvironment = MOCK)
@Slf4j
public class FilterConfigurationPropertiesTest {
    ...
    public void shouldHaveAllProperties() {
        ...
        assertThat(configurationProperties.getAllowedMethods()).isNotNull();
        assertThat(configurationProperties.isAllowedCredentials()).isNotNull();
        assertThat(configurationProperties.getMaxAge()).isNotNull();
    }
}
